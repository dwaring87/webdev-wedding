<template>
    <div class="container py-8">
      <div class="overflow-hidden rounded-lg bg-emerald-800 shadow-xl lg:grid lg:grid-cols-2 lg:gap-4">
        <div class="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
          <div class="lg:self-center">
            ...
            <p class="mt-4 text-lg leading-6 text-emerald-200">Take a self-guided bike tour!</p>
